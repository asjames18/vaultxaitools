...
const communityStats = [
  { label: "Active Users", value: "12,847", icon: UsersIcon, color: "blue" },
  { label: "Reviews Today", value: "234", icon: ChatBubbleIcon, color: "green" },
  { label: "Tools Favorited", value: "8,921", icon: HeartIcon, color: "red" },
  { label: "Avg Rating", value: "4.6", icon: StarIcon, color: "yellow" }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Join thousands of AI enthusiasts discovering and sharing the best tools
          </p>
        </div>

...
export const categories: Category[] = [
  {
    ...
    popularTools: ["ChatGPT", "Claude", "Gemini", "Perplexity AI"]
  },
  {
    name: "AI Agents",
    icon: "⚡",
    ...
    popularTools: ["AutoGPT", "CrewAI", "LangChain", "n8n"]
  },
  {
    name: "Automation",
    icon: "🔄",
    ...
    popularTools: ["Zapier", "Make", "n8n", "Power Automate"]
  },
  {
    ...
    popularTools: ["GitHub Copilot", "Cursor", "Replit", "Vercel"]
  },
  {
    ...
    popularTools: ["ChatGPT", "Runway", "ElevenLabs", "Descript"]
  },
  {
    name: "Productivity",
    icon: "🚀",
    ...
    popularTools: ["Notion", "Obsidian", "Todoist", "ClickUp"]
  },
  {
    name: "Social Media",
    icon: "📱",
  ...
  },
  {
    ...
    popularTools: ["Mailchimp", "ConvertKit", "Beehiiv", "MailerLite"]
  },
  {
    ...
    popularTools: ["WordPress", "Webflow", "Framer", "Squarespace"]
  },
  {
    name: "Communication",
    icon: "💬",
    ...
    popularTools: ["Slack", "Discord", "Microsoft Teams", "Zoom"]
  }
];

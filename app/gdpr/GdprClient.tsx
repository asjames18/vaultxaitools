              ...
              {activeSection === 'overview' && (
                <div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-300 mb-6">
                      At Melanated In Tech, we are committed to protecting your privacy and ensuring compliance with GDPR. We have implemented appropriate technical and organizational measures to ensure a level of security appropriate to the risk.
                    </p>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Lawfulness, fairness, and transparency:</strong> We process personal data lawfully, fairly, and transparently</li>
                      <li><strong className="text-green-400">Purpose limitation:</strong> We collect personal data for specified, explicit, and legitimate purposes</li>
                      <li><strong className="text-green-400">Data minimization:</strong> We only collect personal data that is adequate, relevant, and limited to what is necessary</li>
                      <li><strong className="text-green-400">Accuracy:</strong> We keep personal data accurate and up to date</li>
                      <li><strong className="text-green-400">Storage limitation:</strong> We retain personal data only for as long as necessary</li>
                      <li><strong className="text-green-400">Integrity and confidentiality:</strong> We process personal data securely</li>
                      <li><strong className="text-green-400">Accountability:</strong> We are responsible for demonstrating compliance with these principles</li>
                    </ul>
                    ...
                    <div className="bg-gray-900 border border-green-500/30 rounded-lg p-6 mt-8">
                      ...
                      <a
                        href="/contact"
                        className="inline-block bg-green-500 hover:bg-green-400 text-black px-4 py-2 rounded-lg text-sm font-semibold transition-colors"
                      >
                        Contact DPO
                      </a>
                    </div>
              ...
              {activeSection === 'data-collection' && (
                <div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Account Information:</strong> Email address, username, password</li>
                      <li><strong className="text-green-400">Profile Information:</strong> Name, bio, profile picture</li>
                      <li><strong className="text-green-400">Content:</strong> Reviews, comments, tool submissions</li>
                      <li><strong className="text-green-400">Communication:</strong> Messages sent through contact forms</li>
                      <li><strong className="text-green-400">Preferences:</strong> Settings, language preferences, notification preferences</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Usage Data:</strong> Pages visited, time spent, features used</li>
                      <li><strong className="text-green-400">Technical Data:</strong> IP address, browser type, device information</li>
                      <li><strong className="text-green-400">Cookies:</strong> Session data, preferences, analytics data</li>
                      <li><strong className="text-green-400">Log Data:</strong> Server logs, error logs, performance data</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Consent:</strong> When you explicitly agree to the processing</li>
                      <li><strong className="text-green-400">Contract:</strong> When processing is necessary to fulfill our contract with you</li>
                      <li><strong className="text-green-400">Legitimate Interest:</strong> When processing is necessary for our legitimate interests</li>
                      <li><strong className="text-green-400">Legal Obligation:</strong> When processing is required by law</li>
                      <li><strong className="text-green-400">Vital Interest:</strong> When processing is necessary to protect someone's life</li>
                    </ul>
              ...
              {activeSection === 'data-processing' && (
                <div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li>Providing and maintaining our AI tools and resources directory</li>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Service Providers:</strong> Cloud hosting, analytics, payment processing</li>
                      <li><strong className="text-green-400">Business Partners:</strong> When necessary to provide our services</li>
                      <li><strong className="text-green-400">Legal Authorities:</strong> When required by law or to protect rights</li>
                      <li><strong className="text-green-400">Other Users:</strong> Public information you choose to share</li>
                    </ul>
              ...
              {activeSection === 'data-retention' && (
                <div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Active Accounts:</strong> Retained while your account is active</li>
                      <li><strong className="text-green-400">Inactive Accounts:</strong> Deleted after 2 years of inactivity</li>
                      <li><strong className="text-green-400">Deleted Accounts:</strong> Permanently deleted within 30 days</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Reviews and Comments:</strong> Retained for 5 years after posting</li>
                      <li><strong className="text-green-400">Tool Submissions:</strong> Retained for 7 years after submission</li>
                      <li><strong className="text-green-400">User-Generated Content:</strong> Deleted when account is deleted</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Support Tickets:</strong> Retained for 3 years after resolution</li>
                      <li><strong className="text-green-400">Contact Form Submissions:</strong> Retained for 2 years</li>
                      <li><strong className="text-green-400">Email Communications:</strong> Retained for 2 years</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Log Files:</strong> Retained for 1 year</li>
                      <li><strong className="text-green-400">Analytics Data:</strong> Retained for 2 years</li>
                      <li><strong className="text-green-400">Cookies:</strong> Varies by type (see Cookie Policy)</li>
                    </ul>
              ...
              {activeSection === 'breaches' && (
                <div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Detection and Assessment:</strong> Immediate identification and evaluation of breaches</li>
                      <li><strong className="text-green-400">Containment:</strong> Rapid response to limit the impact</li>
                      <li><strong className="text-green-400">Investigation:</strong> Thorough analysis of the cause and scope</li>
                      <li><strong className="text-green-400">Notification:</strong> Timely communication to affected individuals and authorities</li>
                      <li><strong className="text-green-400">Recovery:</strong> Restoration of systems and data</li>
                      <li><strong className="text-green-400">Review:</strong> Post-incident analysis and improvement</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li><strong className="text-green-400">Supervisory Authority:</strong> Within 72 hours of becoming aware of the breach</li>
                      <li><strong className="text-green-400">Affected Individuals:</strong> Without undue delay when the breach poses a high risk to their rights and freedoms</li>
                      <li><strong className="text-green-400">Data Processors:</strong> Immediately upon becoming aware of a breach</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
                      <li>Email our Data Protection Officer immediately at <a href="mailto:contact@melanatedintech.com" className="text-green-400 hover:text-green-300 underline">contact@melanatedintech.com</a></li>
                    ...
                    <div className="bg-gray-900 border border-red-500/30 rounded-lg p-6 mt-8">
                      ...
                      <a
                        href="/contact"
                        className="inline-block bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors"
                      >

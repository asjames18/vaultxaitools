      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
            ...
            {servers.map((server) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs text-green-400 font-semibold uppercase tracking-wide">MCP Server</span>
                  <span className="text-xs text-gray-600 bg-white/5 border border-white/10 rounded-full px-2 py-0.5">Community Reviewed</span>
                </div>
                <h2 className="text-xl font-bold mb-2 group-hover:text-green-400 transition-colors">{server.name}</h2>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <span className="text-xs text-green-400 group-hover:translate-x-1 transition-transform">View &amp; Integrate &rarr;</span>
                </div>
              </Link>
            ))}
          </div>
        ...
        <div className="mt-20 border-t border-white/10 pt-16 grid md:grid-cols-2 gap-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-3">
            ...
            <Link href="/contact" className="inline-block mt-2 px-5 py-2.5 bg-green-500 hover:bg-green-400 text-black font-bold rounded-lg text-sm transition-colors focus-visible:outline-2 focus-visible:outline-white">
              Submit Your MCP Server
            </Link>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-3">
            <h2 className="text-xl font-bold">New MCP servers weekly</h2>
            <p className="text-gray-400 text-sm">Get notified when new servers drop &mdash; plus integration guides and use-case playbooks.</p>
            <Link href="/#email-capture" className="inline-block mt-2 px-5 py-2.5 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold rounded-lg text-sm transition-colors focus-visible:outline-2 focus-visible:outline-green-500">

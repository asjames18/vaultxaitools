            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button
                  ...
                  className="p-4 bg-gray-800/50 border border-green-900 rounded-lg hover:bg-gray-700/50 transition-colors text-left"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-400">
              © 2025 Melanated In Tech. Performance monitoring and optimization tools for modern web applications.
            </p>
          </div>
        </div>
      </div>

...
export const metadata: Metadata = {
  title: 'Recent Activity - Melanated In Tech',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          <div className="text-center">
            ...
            <Link 
              href="/"
              className="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-400 text-black rounded-lg transition-colors"
            >
              Start Exploring
            </Link>
          </div>
